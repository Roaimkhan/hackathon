        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-0">
              ...
              >
                <div className="flex items-center justify-between">
                  <div className="flex-1">
                    <motion.label
                      animate={{
                        y: confirmPassword ? -24 : 0,
                        fontSize: confirmPassword ? '12px' : '16px',
                      }}
                      transition={{ duration: 0.2 }}
                      className={`absolute transition-colors ${
                        confirmPassword ? 'text-brand-600' : 'text-ink-secondary'
                      } pointer-events-none`}
                    >
                      Confirm Password
                    </motion.label>
            ...
            <motion.button
              ...
              className={`w-full font-semibold py-3.5 rounded-xl transition-all duration-300 mt-8 relative overflow-hidden ${
                isFormValid
                  ? 'bg-gradient-to-r from-brand-700 via-brand-600 to-brand-500 text-white cursor-pointer shadow-[0_20px_40px_-18px_rgba(22,163,74,0.75)]'
